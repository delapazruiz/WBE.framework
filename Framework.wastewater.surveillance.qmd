...
### Figure 9. Wastewater treatment plant. Surveillance

Represent a simulated wastewater surveillance sampling of infected stool events at the treatment plant.
...
dygraph(covid.mh460,
        main = "Early outbreak detection, March 21",
...
dygraph(covid.mh460.peak4,
        main = "Outbreak tail, April 1",
        ylab = "SARS-CoV-2 stool events") %>%
  dyRangeSelector() %>% #dyMultiColumn()|> 
