...
manholes.snt.pol <- read_csv('results/calibration.snt/manholes.snt.pol.df.csv')
...
mholes12m_tbl <- inner_join(mholes_tbl,mh.out.12min.snt.df, by = "manhole.id")
